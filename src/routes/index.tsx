    ...
    <section className="border-b border-[var(--hairline)]">
      <div className="container-page pt-16 md:pt-24 pb-16 md:pb-20 grid lg:grid-cols-12 gap-10 lg:gap-16 items-end">
        <div className="lg:col-span-7">
          ...
          <p className="mt-10 text-base sm:text-2xl leading-[1.75] text-[var(--ink-soft)] max-w-2xl">
            Authorized distributor of Nikon, Bosch & Hi - Target with 10+ years
          ...
          <div className="mt-12 flex flex-wrap items-center gap-6">
            <a
              href="#contact"
              className="inline-flex items-center gap-3 rounded-full bg-[var(--ink)] text-[var(--ivory)] pl-6 pr-3 py-3 text-sm font-medium hover:bg-[var(--cobalt)] transition-colors group"
            >
              Get Official Quotation
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[var(--ivory)] text-[var(--ink)] group-hover:scale-110 transition-transform">
                <ArrowUpRight className="h-3.5 w-3.5" />
              </span>
            </a>
            <a
              href="tel:09971615537"
              className="inline-flex items-center gap-2 text-sm font-medium text-[var(--ink)] border-b-2 border-[var(--ink)] hover:opacity-70 pb-1 transition-opacity"
            >
              <Phone className="h-4 w-4" /> Talk to Expert
            </a>
            <a
              href="#resources"
              className="inline-flex items-center gap-2 text-sm font-medium text-[var(--ink-soft)] hover:text-[var(--ink)] border-b-2 border-transparent hover:border-[var(--ink)] pb-1 transition-colors"
            >
              Request Demo
            </a>
          </div>
          ...
          <div className="mt-5 flex flex-wrap items-center gap-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[13px] leading-5 text-[var(--ink-soft)]">
                  Clients
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <img
                src="/upload/icons/3.png"
                alt="Authorized distributor icon"
                className="h-12 w-12 object-contain"
              />
              <div>
                <div
  ...
  const items = [
    {
      ...
      sub: "Trimble · Nikon · Spectra",
    },
    {
      num: "02",
      icon: Wrench,
      label: "Service in Time",
      sub: "State-of-the-art service centre",
    },
    {
      num: "03",
      icon: ShieldCheck,
      label: "Calibrated Precision",
      sub: "Universal-4 Collimator system",
    },
    {
      num: "04",
      icon: Headphones,
      label: "Pre & After Sales",
      sub: "Highly qualified engineers",
    },
  ];
  return (
    <section className="border-b border-[var(--hairline)]">
      <div className="container-page m-auto grid grid-cols-2 lg:grid-cols-4 divide-x divide-y lg:divide-y-0 divide-[var(--hairline)]">
...
function About() {
  return (
    <section
      id="about"
      className="py-24 md:py-32 border-b border-[var(--hairline)]"
    >
      <div className="container-page grid lg:grid-cols-12 gap-10 lg:gap-16">
        <div className="lg:col-span-4">
          <Eyebrow num="01" label="About" />
          <h2
            className="mt-6 font-serif text-4xl md:text-5xl text-[var(--ink)] leading-[1.05]"
            style={{ fontFamily: "Fraunces, serif" }}
          >
            Sankon{" "}
            <span className="italic text-[var(--ink-soft)]">Technologies</span>{" "}
            India Pvt Ltd.
          </h2>
        </div>
        ...
        <div className="flex items-end justify-between gap-6 flex-wrap mb-14">
          <div>
            ...
            <h2
              ...
              style={{ fontFamily: "Fraunces, serif" }}
            >
              Our <span className="italic">Category</span>
            </h2>
          </div>
          <a
            href="#categories"
            className="text-sm text-[var(--ink)] inline-flex items-center gap-2 border-b border-[var(--ink)]/30 hover:border-[var(--ink)] pb-1"
          >
              ...
              <div className="group relative border-r border-b border-[var(--hairline)] bg-[var(--paper)] flex flex-col overflow-hidden">
                ...
                <div className="p-6 border-t border-[var(--hairline)] flex flex-col items-center">
                  ...
                  {p.brandLinks ? (
                    ...
                    <p className="text-lg text-[#043c77]">{p.brands}</p>
                  )}
                </div>
              </div>
            );
      ...
      <div className="container-page">
        <div className="border border-[var(--hairline)] bg-[var(--paper)] grid lg:grid-cols-2 overflow-hidden">
          <div className="p-10 md:p-14 flex flex-col justify-between gap-10 border-b lg:border-b-0 lg:border-r border-[var(--hairline)]">
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-3 rounded-full bg-[var(--ink)] text-[var(--ivory)] pl-6 pr-2 py-2 text-sm font-medium hover:bg-[var(--cobalt)] transition-colors w-fit group"
            >
              Enquiry Now
        ...
        <div className="mt-20 max-w-3xl">
          ...
          <p className="mt-6 text-[var(--ink-soft)] text-[17px] leading-[1.7]">
            Complete solution for requirement of Surveying, Construction,
            Measuring, Aligning and Positioning instruments.
          </p>
        </div>
      </div>
    </section>
...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div className="p-8 md:p-10 first:border-t-0 [&:nth-child(2)]:border-t-0">
      <div
        className="font-serif text-4xl md:text-5xl text-[var(--ink)]"
        style={{ fontFamily: "Fraunces, serif" }}
      >
        {value}
      </div>
...
function Service() {
  const points = [
    ...
    },
    {
      num: "02",
      icon: ShieldCheck,
      title: "Trimble Nikon Standards",
      text: "Set-up as per Trimble Nikon guidelines, equipped with Special Tools and Jigs.",
    },
    {
      num: "03",
      icon: Award,
      title: "Universal-4 Collimator",
      text: "Self adjusted collimation system — adjustments free from human error.",
    },
    {
      num: "04",
      icon: Headphones,
      title: "Centre for Competence",
      text: "Prompt Pre-and-After Sales Support, with stock of spare parts.",
    },
  ];
  return (
    <section
      id="service"
      className="py-24 md:py-32 border-b border-[var(--hairline)] bg-[var(--ivory-deep)]"
    >
      <div className="container-page">
      ...
      <div className="container-page">
        ...
        <div className="mt-14 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 border-t border-l border-[var(--hairline)]">
          {brandIds.map((id) => (
            <div
              key={id}
              className="border-r border-b border-[var(--hairline)] aspect-[3/2] flex items-center justify-center p-5 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all bg-[var(--paper)]"
            >
              <img
                src={`/upload/brand/${id}.png`}
                alt="brand"
                loading="lazy"
  ...
  return (
    <li className="flex gap-5 pb-6 border-b border-[var(--hairline)] last:border-0">
      ...
      <div>
        ...
        <div className="mt-2 text-sm text-[var(--ink)] leading-relaxed">
          {children}
        </div>
      </div>
    </li>
...
function WhySankon() {
  const items = [
    ...
    },
    {
      ...
      text: "Nationwide coverage for installation, calibration and repair.",
    },
    {
      num: "03",
      title: "Certified Engineers",
      text: "Highly qualified technical team trained on OEM platforms.",
    },
    {
      num: "04",
      title: "OEM Procedures",
      text: "Service performed per Trimble Nikon guidelines with original tools and jigs.",
    },
  ];
  return (
    <section
  ...
  const items = [
    {
      ...
      text: "Total stations, levels and GNSS for site layout and as-built surveys.",
    },
    {
      icon: TrainFront,
      title: "Railways",
      text: "Track alignment, geometry and route surveys with precision instruments.",
    },
    {
      icon: Mountain,
      title: "Mining",
      text: "Volumetric surveys, slope monitoring and exploration support.",
    },
    {
      icon: Waves,
    ...
    },
    {
      ...
      text: "Geodetic control, monitoring and machine control deployments.",
    },
    {
      icon: Factory,
      title: "Industrial & Plant",
      text: "Alignment, layout and dimensional control for plants and structures.",
    },
  ];
  return (
    <section
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 border-t border-l border-[var(--hairline)]">
          {items.map(({ icon: Icon, title, text }) => (
            <a
              key={title}
              href="#contact"
              className="group border-r border-b border-[var(--hairline)] bg-[var(--paper)] p-8 flex flex-col gap-5 hover:bg-[var(--ivory)] transition-colors"
            >
  ...
  const items = [
    {
      num: "01",
      title: "Calibration",
      text: "Universal-4 Collimator based calibration free from human error, with full certification.",
    },
    {
      num: "02",
      title: "Repair",
    ...
    },
    {
      ...
      text: "Scheduled preventive maintenance plans to keep instruments field-ready year round.",
    },
    {
      num: "04",
      title: "Warranty Support",
      text: "Genuine warranty handling backed by OEM procedures and qualified engineers.",
    },
  ];
  return (
    <section
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16">
          <div className="lg:col-span-5">
            ...
            <h2
              ...
              style={{ fontFamily: "Fraunces, serif" }}
            >
              Calibration, Repair, <span className="italic">AMC</span> &
              Warranty
            </h2>
            <p className="mt-6 text-[15px] leading-[1.8] text-[var(--ink-soft)]">
              Complete lifecycle support for surveying instruments — from first
              installation to long-term care.
            </p>
            <a
              href="#contact"
              className="mt-8 inline-flex items-center gap-3 rounded-full bg-[var(--ink)] text-[var(--ivory)] pl-6 pr-2 py-2 text-sm font-medium hover:bg-[var(--cobalt)] transition-colors w-fit group"
            >
              Request Service
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[var(--ivory)] text-[var(--ink)]">
                <ArrowUpRight className="h-3.5 w-3.5" />
  ...
  const items = [
    {
      ...
      text: "Get the complete product catalog with specifications.",
      cta: "Download PDF",
    },
    {
      icon: Calendar,
      title: "Request a Demo",
      text: "Schedule an on-site or online demo with our engineers.",
      cta: "Book Demo",
    },
    {
      icon: MessageSquare,
      title: "Free Consultation",
      text: "Talk to a specialist about the right instrument for your project.",
      cta: "Talk to Expert",
    },
  ];
  return (
      ...
      <div className="container-page">
        ...
        <div className="mt-14 grid md:grid-cols-3 border-t border-l border-[var(--hairline)]">
          {items.map(({ icon: Icon, title, text, cta }) => (
            <div
              key={title}
              className="border-r border-b border-[var(--hairline)] bg-[var(--paper)] p-8 flex flex-col gap-6"
            >
              ...
              <a
                href="#contact"
                className="mt-auto inline-flex items-center gap-2 text-sm font-medium text-[var(--ink)] hover:text-[var(--cobalt)]"
              >
...
function Faq() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Calibration is performed with the Universal-4 Collimator — a self-adjusted collimation system that removes human error. Distomat diodes are aligned with a CCD device attached to a powerful telescope.",
    },
    {
      q: "Do you offer AMC and warranty support?",
      a: "Yes. We offer Annual Maintenance Contracts and genuine warranty support, with sufficient stock of spare parts to deliver the fastest response.",
    },
    {
      q: "Where is the service centre located?",
      a: "Our state-of-the-art service centre is in Noida, Uttar Pradesh, with PAN India service support for customers across the country.",
    },
    {
              ...
              <div key={f.q} className="border-b border-[var(--hairline)]">
                ...
                >
                  <span className="flex items-baseline gap-4">
                    ...
                    <span
                      className="font-serif text-lg md:text-xl text-[var(--ink)]"
                      style={{ fontFamily: "Fraunces, serif" }}
                    >
                      {f.q}
                    </span>
                  ...
                  {isOpen ? (
                    <Minus className="h-4 w-4 shrink-0 text-[var(--ink-soft)]" />
                  ) : (
                    <Plus className="h-4 w-4 shrink-0 text-[var(--ink-soft)]" />
                  )}
                </button>
                {isOpen && (
                  <p className="pb-6 pl-10 pr-10 text-sm text-[var(--ink-soft)] leading-[1.8] max-w-3xl">
                    {f.a}
                  </p>
                )}
              </div>
