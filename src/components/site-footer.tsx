...
export function SiteFooter() {
  return (
    <footer className="bg-[#021B33] text-white mt-10 overflow-hidden">
      ...
      {/* Footer Grid */}
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-3">
        ...
        {/* Categories: render main categories and their brand links from categoryData */}
        <div className="lg:col-span-4">
          <h4 className="text-sm font-semibold tracking-widest text-white/75 mb-7">
            CATEGORIES
          </h4>

          <ul className="grid grid-cols-2 gap-x-1 gap-y-4">
            {categories.map((cat) => (
          ...
          <div className="space-y-6 text-[15px] leading-7 text-white/70">
            ...
            <div className="flex gap-4">
              ...
              <p className="text-white/45 text-[14px]">
                D - 91, Sector - 06, Noida -201 301,  Uttar Pradesh
              </p>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                className="hover:text-white transition-colors text-white/45 text-[14px]"
              >
